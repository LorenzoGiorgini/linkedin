            ...
            <div className="d-flex">
                <div className="image-container">
                    <div className="img-profile-container">
                        <img className="profile-img" src="https://via.placeholder.com/150"/>
                    </div>
                </div>
                <div className="d-flex flex-column ml-2 mb-2">
                    
                    <div className="d-flex">
                        <div className="span-big">
                            name
                        </div>
                        <div>
                            <Dropdown>
                                <Dropdown.Toggle style={{background:"transparent"  , color: "black"}} id="dropdown-basic">
                                    ...
                                </Dropdown.Toggle>
